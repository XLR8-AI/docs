...
Approved **AI Brand Learnings** from comment threads further steer future content.
...
- Check the threads you want to reuse, then click **Add to brand learnings**. The button shows how many threads are selected. Threads already saved as a brand learning cannot be selected again.

...
A **query set** is a reusable briefing plus category map. It stores experiment type and subtype, company name, domain, aliases, categories, queries, and optional Keyword Planner keywords with language and location targeting.

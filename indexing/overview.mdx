...
If a connection expires, that engine shows **Reconnect required** instead of **Not connected**, with a note that the token has expired. Click **Reconnect** and complete OAuth again to restore access.
...
<CardGroup cols={2}>
  ...
  <Card title="Reporting" icon="chart-mixed" href="/reporting/overview">
    Review Search Console and Analytics performance after pages are live.
  </Card>
</CardGroup>

...
<Tabs>
  <Tab title="Admin">
    ...
    - Approve, edit, dismiss, add, import, or delete **AI Brand Learnings**
    - Manage org-wide **Experiment Schedules** in Settings
    - Use all product features (experiments, content, intelligence, integrations)
  </Tab>
  <Tab title="Member">
    Members can use product features but cannot manage org-level brand guidelines, add or dismiss learnings in Settings, or change schedule settings reserved for admins. As a member, you can:

    - Create and run experiments
    - Generate and optimize content
    - Add comment threads as **AI Brand Learnings** from the content **Comments** sidebar
    - Approve and edit **AI Brand Learnings** in Settings

...
<Tabs>
  ...
  <Tab title="Member">
    Members can use product features but cannot manage org-level brand guidelines, add or dismiss learnings, or change schedule settings reserved for admins. As a member, you can:

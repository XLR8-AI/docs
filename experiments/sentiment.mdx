...
On **Detailed Analysis**, **Pros** and **Cons** default to **Self** — only phrases attributed to your brand (including company aliases). Switch to **Competitor** to see phrases attributed to other brands, each labeled with the brand name. Phrases without a brand attribution are hidden in both views.

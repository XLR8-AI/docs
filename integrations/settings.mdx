...
Navigate to **Settings** from the **General** section of the main sidebar at any time. Invoices and payment methods live under **Settings → Billing** — see [Billing](/account/billing).
...
Under **Brand Corrections → AI Brand Learnings**, review corrections captured from content comment threads. On a generated content piece, check threads in the **Comments** sidebar and click **Add to brand learnings** to send them here.
...
<CardGroup cols={2}>
  ...
  <Card title="Reporting" icon="chart-mixed" href="/reporting/overview">
    Connect Google Search Console and Analytics, and upload monthly attribution CSVs.
  </Card>

  <Card title="Outreach Email" icon="envelope" href="/outreach/overview">
    Connect Gmail, set a sender name for generated emails, and send listicle outreach from XLR8.ai.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Billing" icon="credit-card" href="/account/billing">
    View invoices, pay on Stripe or in XLR8, and manage your payment method.
  </Card>
